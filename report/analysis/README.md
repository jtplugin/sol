...
| `01_fatti.ipynb` | Il notebook. Legge `tidy.csv`, fa i conti, scrive `FACTSHEET.md`. |
| `01_fatti.html` | Lo stesso notebook già eseguito, per leggerlo senza installare niente. |
...
- I **fatti**: `FACTSHEET.md` qui accanto, o `01_fatti.html` se preferisci vedere anche i grafici.
