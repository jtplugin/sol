...
- Build the result as JSON: {"status": "OK", "item": {{decision}}, "remaining_hours": {{remaining_hours}}}. JSON ONLY, no other fields, exact key casing. [from context: decision, remaining_hours]
