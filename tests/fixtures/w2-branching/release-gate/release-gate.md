...
```json
{
  "ROUTINE": [
    ...
    {
      "IF": {
        "when": "record_path was not provided, the file could not be read, or the record is missing any of coverage / blocking_bugs / security_review, or a field has the wrong type",
        "then": [
          {"TODO": "Emit verbatim: [fixture-w2-release-gate][main] BRANCH: branch-guard"},
      ...
      "WHEN": [
        {
          ...
          "then": [
            {"TODO": "Emit verbatim: [fixture-w2-release-gate][main] BRANCH: branch-0"},
        ...
        },
        {
          ...
          "then": [
            {"TODO": "Emit verbatim: [fixture-w2-release-gate][main] BRANCH: branch-1"},
        ...
        },
        {
          ...
          "then": [
            {"TODO": "Emit verbatim: [fixture-w2-release-gate][main] BRANCH: branch-2"},
            {"RETURN": {"verdict": "SECURITY_HOLD"}}
          ]
        },
        {
          "else": [
            {"TODO": "Emit verbatim: [fixture-w2-release-gate][main] BRANCH: branch-else"},
